...
model_zs = SummaCZS(granularity="sentence", model_name="vitc", device="cuda", max_doc_sents=800, batch_size=1) # If you have a GPU: switch to: device="cuda"
model_conv = SummaCConv(models=["vitc"], bins='percentile', granularity="sentence", nli_labels="e", device="cuda", start_file="default", agg="mean", max_doc_sents=800, batch_size=1)
